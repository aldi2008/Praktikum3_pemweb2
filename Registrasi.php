...
<body>
  <div class="container mt-4">
    ...
    if (isset($_POST['submit'])) {
      ...
      echo 'NIM: ' . $nim . '</li>';
      echo '<br>Nama: ' . $nama . '</li>';
      echo '<br>Jenis Kelamin: ' . $jenis_kelamin . '</li>';
      echo '<br>Program Studi: ' . $program_studi . '</li>';
      echo '<br>Skill Web & Pemrogramman: ' . implode(', ', $skills) . '</li>';
      echo '<br>Domisili: ' . $tempat . '</li>';
      echo '<br>Email: ' . $email . '</li>';
      echo '</div>';
    }
    ?>
